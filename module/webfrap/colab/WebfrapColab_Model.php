 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class WebfrapColab_Model extends Model
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
//////////////////////////////////////////////////////////////////////////////*/
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  /**
   * @param WebfrapFile_Table_Search_Request $params
   * @return array
   */
...
SQL;
  ...
  public function getUserListByKey($key, $params)
  {
    ...
    $db = $this->getDb();
    $query = $db->newQuery('WebfrapFile');
    /* @var $query WebfrapFile_Query  */
...
SQL;
  ...
  /**
   * @param int $messageId
   * @param WebfrapFile_Save_Request $rqtData
   * @throws Per
   */
...
SQL;
   ...
   *
   * @param User $user
   * @return WebfrapFile_Table_Search_Settings
   */
  ...
  /**
   * @param WebfrapFile_Table_Search_Settings $settings
   */
