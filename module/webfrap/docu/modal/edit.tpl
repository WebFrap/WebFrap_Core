<div class="wgt-panel" >
  <div class="wgt-panel-control" >
    <button class="wgtac_save wgt-button" ><i class="icon-save" ></i> <?php echo $this->i18n->l('Save','wbf.label') ?></button>
  </div>
  
  <div class="wgt-panel-control" >
    <button class="wgtac_save_a_close wgt-button" ><i class="icon-save" ></i> <?php echo $this->i18n->l('Save & Show','wbf.label') ?></button>
  </div>
</div>
